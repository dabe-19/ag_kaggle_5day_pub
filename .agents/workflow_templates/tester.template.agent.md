...
<workflow>
## 1. Discover
- Read `@{{IMPLEMENTATION_PLAN_PATH}}` via `antigravity/memory` to understand the scope.
...
Routing:
- **All steps passed** → call `/george` with "Tester completed end-to-end verification. Read @{{IMPLEMENTATION_PLAN_PATH}} and render your verdict."
